...
struct Connexion;
using namespace std;
/**define pred for search the page's section,modified by shenyj*/

 class section :public unary_function<std::string, bool>{
		std::string s;
	public:
		explicit section(const std::string& ss) :s(ss){}
